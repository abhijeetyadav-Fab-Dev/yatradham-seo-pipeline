# Graph Report - yatradham-seo-pipeline  (2026-08-27)

## Corpus Check
- 40 files · ~75,957 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 496 nodes · 963 edges · 24 communities (23 shown, 1 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 47 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65500c99`
...
Cohesion: 0.10
Nodes (44): bulk_update_status(), clear_all_outputs(), delete_output(), _dict_to_sections(), _execute_with_retry(), get_audit_trail(), get_conn(), get_output() (+36 more)

### Community 3 - "LLMClient"
Cohesion: 0.05
Nodes (47): _extract_json_from_response(), Any, Content agent: generates all 19 structured sections from scraped page data., Robustly extract JSON from LLM response, handling markdown blocks and…, run(), _clean_markdown(), _generate_long_form_blog(), _parse_markdown_sections() (+39 more)
...
Cohesion: 0.05
Nodes (68): BackgroundTasks, analyze_keywords_endpoint(), batch_urls(), BatchURLRequest, bulk_action(), check_ai_endpoint(), CheckAIRequest, clear_cache() (+60 more)
...
### Community 21 - "get_forex_rates_endpoint"
Cohesion: 0.50
...
Cohesion: 0.12
Nodes (20): Any, field_validator, BatchRequest, BulkActionRequest, FAQItem, ItineraryDay, NearbyLocation, PricingRow (+12 more)
...
- **Why does `LLMClient` connect `LLMClient` to `database.py`, `qa_agent.py`, `TestArchitecturalDecoupling`, `main.py`, `process_package`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `run_validation()` connect `validation_layer.py` to `process_package`, `LLMClient`, `main.py`?**
